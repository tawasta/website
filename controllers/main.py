...
class website_sale(website_sale):
	...
	def checkout_values(self, data=None):
		...
		self.mandatory_billing_fields = ["name", "email", "city", "country_id", "zip", "street", "street2", "phone" ]
		self.optional_billing_fields = ["businessid", "businessid_shown", "is_company", "vatnumber_shown", "website", "function"]
