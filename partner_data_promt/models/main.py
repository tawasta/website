...
class PartnerDataPromptRule(models.Model):
    ...
    condition_domain = fields.Char(help="Python domain syntax, e.g. [('is_member','=',True)]")
    info_text = fields.Text(string="Prompt Text", help="Explanation shown to user when prompting this field")
