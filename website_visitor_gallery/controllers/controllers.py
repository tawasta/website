...
class VisitorImgUpload(http.Controller):
    ...
    def visitor_gallery(self, **kw):
        ...
        image_urls_by_category = http.request.env[
            "visitor.image"
        ].get_image_urls_by_category()
        return http.request.render(
            "website_visitor_gallery.visitor_gallery",
            {
    ...
    def create_slide(self, *args, **post):
        if post.get("image"):
            try:
                ...
                print(e)
                return http.request.render(
                    "website_visitor_gallery.visitor_gallery_error", {"message": ""}
                )
